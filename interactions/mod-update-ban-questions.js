...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        try {
            ...
            config.banAppealSystem.questions = questions;
            await config.save();
            
            await interaction.reply({
                content: `✅ Ban appeal questions have been updated successfully! (${questions.length} questions saved)`,
                flags: ["Ephemeral"]
            });
            
        } catch (error) {
            console.error('Error updating ban questions:', error);
