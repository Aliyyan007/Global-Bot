...
module.exports = {
    ...
    run: async (client, interaction, args) => {
        try {
            ...
            config.timeoutAppealSystem.appealChannel = channelId;
            await config.save();
            
            await interaction.reply({
                content: `✅ Timeout appeal channel has been updated to <#${channelId}>`,
                flags: ["Ephemeral"]
            });
            ...
            console.error('Error editing timeout channel:', error);
