...
module.exports = {
    name: 'mod-edit-max-appeals-timeout',
    isModal: true,
    ...
    run: async (client, interaction, args) => {
        try {
            ...
            config.timeoutAppealSystem.maxAppealsPerUser = maxAppeals;
            await config.save();
            
            await interaction.reply({
                content: `✅ Maximum timeout appeals per user has been set to: ${maxAppeals}`,
                flags: ["Ephemeral"]
            });
            ...
            console.error('Error editing max timeout appeals:', error);
